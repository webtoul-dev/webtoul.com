  ...
  <div class="max-w-4xl mx-auto px-4 py-12">
    <div class="bg-white rounded-lg shadow-lg p-8">
      <div class="terms-content text-left">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Web Toul Solutions, 173 Wooster St,
          ...
          <li>
            <p>
              <strong>Website</strong> refers to WebToul, accessible from
              <a
                href="https://webtoul.com"
        ...
        <ul>
          <li>By email: connect@webtoul.com</li>
        </ul>
      </div>
    </div>
  </div>
